...
const JakesResume = () => {
  ...
  return (
    <div
      className={`jakes-resume ${lato.className} ${montserrat.className} ${nunito.className} ${openSans.className} ${raleway.className} ${roboto.className}`}
      style={{
      ...
      >
        ...
        <div className="basic-info text-center">
          ...
          <div className="contacts-info flex flex-wrap justify-center gap-4  mt-1">
            ...
            {linkedInProfile && (
              <>
                <Link href={linkedInProfile.url} className="linkedin underline">
                  {linkedInProfile.url}
                </Link>
              </>
            )}
            ...
            {githubProfile && (
              <Link href={githubProfile.url} className="github underline">
                {githubProfile.url}
              </Link>
            )}
          </div>
