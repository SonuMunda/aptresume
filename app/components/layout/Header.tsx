    ...
    >
      ...
      <div className="flex items-center gap-10">
        ...
        >
          ...
          <ul
            className={`nav-list flex flex-col text-black md:flex-row md:items-center mt-4 p-2 md:p-0 md:m-0`}
          >
            <li className="list-items" onClick={() => setMenuOpen(false)}>
              <Link
                href="/find-job"
                className="nav-link text-[16px] block rounded-xl mx-2 hover:bg-blue-100 md:hover:bg-transparent"
              >
                Find Job
              </Link>
            </li>
